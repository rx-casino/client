...
<script>
  ...
  $: xBet = null;
  $: coinImage = "https://cryptologos.cc/logos/thumbs/solana.png?v=034";
  $: coinName = "SOL";
  ...
  $: {
    ...
    if (!game && _game) {
      ...
      autorun(() => {
        ...
        inputDisabled = coinName !== "Fun Coupons" && coinName !== "SOL";
        canBet = game.canBet && (coinName === "Fun Coupons" || coinName === "SOL" );
        ...
        <div class="sc-eqUgKp iuHOYP">
          ...
          <div class="forms {$newScreen < 1100 ? 'mobile-view' : ''}">
            <div
              ...
              {#if !(coinName === "SOL" || coinName === "Fun Coupons")}
